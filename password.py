...
class Password_Generator:
    ...
    def gen_sequence(
        conditions,
    ):  # must have  conditions (in a list format), for each member of the list possible characters
        possible_characters = [
            str.ascii_lowercase,
            str.ascii_uppercase,
            str.digits,
...
class Interface:
    ...
    def generate_password(self, lenght):
        sequence = Password_Generator.gen_sequence(list(self.has_characters.values()))
        print(Password_Generator.gen_password(sequence, lenght))
